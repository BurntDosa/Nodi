...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) => WelcomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'loginpageCopyCopy',
              path: 'loginpageCopyCopy',
              builder: (context, params) => LoginpageCopyCopyWidget(),
            ),
            FFRoute(
              name: 'interests',
              path: 'interests',
            ...
            FFRoute(
              name: 'plus1system',
              path: 'plus1system',
              builder: (context, params) => Plus1systemWidget(),
            ),
            FFRoute(
              name: 'qrcode',
              path: 'qrcode',
